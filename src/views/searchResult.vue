...
<div v-loading="loading">
    <div class="shop">
      <el-row>
        <el-col :span="5" v-for="(good, index) in goods" :key="index" :offset="index %4 ==0 ? 4 : 0">
            ...
            <el-row  style="text-align:left">
              <el-col :span="2" :offset="9" >
                 <i class="el-icon-shopping-cart-2 cart" @click="addCart(good.salerId,good.productId)"></i>
                </el-col>
            </el-row>
...
export default {
  ...
  methods: {
    ...
    cutString(str, len) {
     ...
     addCart(salerId,productId){
      
      let param = {salerId:salerId,productId:productId}
